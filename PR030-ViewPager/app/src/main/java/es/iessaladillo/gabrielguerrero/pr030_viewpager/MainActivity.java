package es.iessaladillo.gabrielguerrero.pr030_viewpager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*Snackbar.make(view, "Página " + mSectionsPagerAdapter.getPageTitle(mViewPager.getCurrentItem()), Snackbar.LENGTH_LONG)
